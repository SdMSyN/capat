  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
			<div class="row">
				...
				<div class="col-xs-5 ">
					<div class="btn-group pull-right">
						<a href="#" class="btn btn-default" data-toggle="modal" data-target="#modalAddService"><i class="fa fa-plus"></i> Nuevo</a>
			...
			<!-- modal añadir servicio -->
				<form class="form-horizontal" id="formAddService" name="formAddService">
					<div class="modal fade" id="modalAddService" tabindex="-1" role="dialog" aria-labellebdy="myModalLabel">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="form-group">
										<label for="inputService" class="col-sm-3 control-label">Nombre</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="inputService" name="inputService" required>
										</div>
									</div>
								</div><!-- ./modal-body -->
			...
			<!-- modal editar servicio -->
				<form class="form-horizontal" id="formUpdService" name="formUpdService">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="form-group">
										<label for="inputService" class="col-sm-3 control-label">Nombre</label>
										<div class="col-sm-9">
											<input type="hidden" class="form-control" id="inputIDService" name="inputIDService" required>
											<input type="text" class="form-control" id="inputService" name="inputService" required>
										</div>
									</div>
								</div><!-- ./modal-body -->
  ...
  <!-- /.content-wrapper -->
			...
			$("#data").on("click", "#editar", function(){
				...
				$.ajax({
					...
					success: function(msg){
						...
						$("#modalUpdColony .modal-body #inputIDService").val(datos.dataRes[0].id);
						$("#modalUpdColony .modal-body #inputService").val(datos.dataRes[0].nombre);
						$(".loader").hide();
					},
					error: function(x, e){
						var cadErr = '';
	...
	<script>
		...
		form1.validate({ 
			...
			messages:{
				inputService: "Nombre del servicio obligatorio",
			},
		...
		$( "#formAddService" ).submit(function( event ) {
			...
			if (form1) {
				...
				$.ajax({
					type: "POST",
					url: "../controllers/create_service.php",
					data: parametros,
					success: function(msg){
						var datos = jQuery.parseJSON(msg);
						if(datos.error == 0){
	...
	<script>
		...
		form2.validate({ 
			...
			messages:{
				inputName: "Nombre servicio obligatorio"
			},
			errorPlacement: function ( error, element ) {
				error.addClass( "help-block" );
				element.parents( ".col-sm-9" ).addClass( "has-feedback" );
		...
		$( "#formUpdService" ).submit(function( event ) {
			...
			if (form2) {
				...
				$.ajax({
					type: "POST",
					url: "../controllers/update_service.php",
					data: parametros,
					success: function(msg){
						console.log(msg);
						var datos = jQuery.parseJSON(msg);
